...
When it comes to **binary features**, the intension for the word bird could be made of features like [+living], [-mammal], [+wings], [+eggs],   [+flying]. Some of these features could also describe other words. 
For example, similar features can denote a fish, with the difference 
of [-wings], [-flying], [+swimming]. Such a feature composition, also known as componential analysis, captures similarities and differences across categories of things in the world.
